...
#Region "Data Access Methods"
    ...
    ''' <summary>
    ''' Returns a single palette entry as a .NET Color (opaque)
    ''' </summary>
    ''' <param name="index">Palette index (0-255)</param>
    Public Function GetColor(index As Integer) As System.Drawing.Color
        If index < 0 OrElse index > 255 Then
            Return System.Drawing.Color.Black
        End If
        Return System.Drawing.Color.FromArgb(255, palData(index).rgbRed, palData(index).rgbGreen, palData(index).rgbBlue)
    End Function
